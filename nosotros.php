			...
			<div id="main" class="wrapper style1">
				<div class="container">
					<section>
						<header class="major">
							<h2>¿Quiénes somos?</h2>
							<span class="byline">El bienestar y confort de tu mascota es nuestro compromiso.</span>
						</header>
						<p>La residencia canina Veiga do Ulla nace de la necesidad por parte de nuestros amigos y familiares de encontrar un buen alojamiento para nuestras mascotas. Un alojamiento en el que contasen con todas las comodidades, seguridad, vigilancia y por supuesto todo ello con un trato absolutamente familiar y garantizado. Es por ello que decidimos fomalizar el proyecto y creamos la residencia canina Veiga do Ulla, donde la principal meta es que sus mascotas se encuentren como en su propia casa, atendidas, cuidadas y mimadas como si de nuestras propias mascotas se tratasen, y todo ello en un entorno natural y en un ambiente relajado y tranquilo.</p>
					</section>
				</div>
			</div>
